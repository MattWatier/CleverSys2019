...
add_image_size( 'post-thumbnail', 300, 300, false );

add_filter('the_content', 'disable_autocomplete', 99);
function disable_autocomplete( $content )
{
    return str_replace('[more]', '</p></div><a id="more" style="cursor: pointer;">read more content</a><div class="row hiddencontent" style="display:none"><p>', $content);
}
